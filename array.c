...
const asn1_static_node kerberosV5spec2_asn1_tab[] = {
  ...
  { "encapContentInfo", 2, "EncapsulatedContentInfo"},
  ...
  { "Int32", 1611137027, NULL },
  { "-2147483648", 10, "2147483647"},
  ...
  { "elements", 536879106, "AuthorizationData"},
  { NULL, 2056, "1"},
  { "AD-MANDATORY-FOR-KDC", 1073741826, "AuthorizationData"},
  { "id-pkinit", 1879048204, NULL },
  { "iso", 1073741825, "1"},
  { "identified-organization", 1073741825, "3"},
  { "dod", 1073741825, "6"},
  { "internet", 1073741825, "1"},
  ...
  { "kerberosv5", 1073741825, "2"},
  { "pkinit", 1, "3"},
  { "id-pkinit-authData", 1879048204, NULL },
  { NULL, 1073741825, "id-pkinit"},
  { NULL, 1, "1"},
  { "id-pkinit-DHKeyData", 1879048204, NULL },
  { NULL, 1073741825, "id-pkinit"},
  { NULL, 1, "2"},
  { "id-pkinit-rkeyData", 1879048204, NULL },
  { NULL, 1073741825, "id-pkinit"},
  { NULL, 1, "3"},
  { "id-pkinit-KPClientAuth", 1879048204, NULL },
  { NULL, 1073741825, "id-pkinit"},
  { NULL, 1, "4"},
  { "id-pkinit-KPKdc", 1879048204, NULL },
  { NULL, 1073741825, "id-pkinit"},
  { NULL, 1, "5"},
  { "id-pkinit-san", 1879048204, NULL },
  { "iso", 1073741825, "1"},
  { "org", 1073741825, "3"},
  { "dod", 1073741825, "6"},
  { "internet", 1073741825, "1"},
  ...
  { "kerberosv5", 1073741825, "2"},
  { "x509SanAN", 1, "2"},
  { "pa-pk-as-req", 1342177283, "16"},
  { "pa-pk-as-rep", 1342177283, "17"},
  { "ad-initial-verified-cas", 1342177283, "9"},
  { "td-trusted-certifiers", 1342177283, "104"},
  { "td-invalid-certificates", 1342177283, "105"},
  { "td-dh-parameters", 1342177283, "109"},
  { "PA-PK-AS-REQ", 1610612741, NULL },
  { "signedAuthPack", 536879111, NULL },
  { NULL, 4104, "0"},
  { "DHNonce", 1073741831, NULL },
  { "ExternalPrincipalIdentifier", 1610612741, NULL },
  { "subjectName", 1610637319, NULL },
  { NULL, 4104, "0"},
  { "issuerAndSerialNumber", 1610637319, NULL },
  { NULL, 4104, "1"},
  { "subjectKeyIdentifier", 536895495, NULL },
  { NULL, 4104, "2"},
  { "AuthPack", 1610612741, NULL },
  { "pkAuthenticator", 1610620930, "PKAuthenticator"},
  { NULL, 2056, "0"},
  { "clientPublicValue", 536895490, "SubjectPublicKeyInfo"},
  { NULL, 2056, "1"},
  { "PKAuthenticator", 1610612741, NULL },
  { "cusec", 1611145219, NULL },
  { NULL, 1073743880, "0"},
  { "0", 10, "999999"},
  { "ctime", 1610620930, "KerberosTime"},
  { NULL, 2056, "1"},
  { "nonce", 1611145219, NULL },
  { NULL, 1073743880, "2"},
  { "0", 10, "4294967295"},
  { "paChecksum", 536895495, NULL },
  { NULL, 2056, "3"},
  { "TD-TRUSTED-CERTIFIERS", 1610612747, NULL },
  { NULL, 2, "ExternalPrincipalIdentifier"},
  { "TD-INVALID-CERTIFICATES", 1610612747, NULL },
  { NULL, 2, "ExternalPrincipalIdentifier"},
  ...
  { NULL, 2056, "1"},
  { "AD-INITIAL-VERIFIED-CAS", 1610612747, NULL },
  { NULL, 2, "ExternalPrincipalIdentifier"},
  { "PA-PK-AS-REP", 1610612754, NULL },
  { "dhInfo", 1610620930, "DHRepInfo"},
  { NULL, 2056, "0"},
  { "encKeyPack", 536879111, NULL },
  { NULL, 4104, "1"},
  { "DHRepInfo", 1610612741, NULL },
  { "dhSignedData", 1610620935, NULL },
  { NULL, 4104, "0"},
  { "serverDHNonce", 536895490, "DHNonce"},
  { NULL, 2056, "1"},
  { "KDCDHKeyInfo", 1610612741, NULL },
  { "subjectPublicKey", 1610620934, NULL },
  { NULL, 2056, "0"},
  { "nonce", 1611145219, NULL },
  { NULL, 1073743880, "1"},
  { "0", 10, "4294967295"},
  { "dhKeyExpiration", 536895490, "KerberosTime"},
  { NULL, 2056, "2"},
  { "ReplyKeyPack", 1610612741, NULL },
  { "replyKey", 1610620930, "EncryptionKey"},
  { NULL, 2056, "0"},
  { "asChecksum", 536879106, "Checksum"},
  { NULL, 2056, "1"},
  { "TD-DH-PARAMETERS", 536870923, NULL },
